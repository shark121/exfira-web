...
async def lifespan(app: FastAPI):
    global redactor, compliance_log
    logger.info("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    logger.info("  Exfira API (ChatGPT redaction) starting up")
    logger.info("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    logger.info("Redaction engine : ChatGPT (%s)", os.getenv("REDACTION_MODEL", "gpt-4o-mini"))
    redactor = Redactor()
    compliance_log = ComplianceLogger(log_dir=os.getenv("COMPLIANCE_LOG_DIR", "logs"))
    logger.info("Chat model       : %s", os.getenv("LLM_MODEL", "gpt-4o-mini"))
    logger.info("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    yield
    logger.info("Shutting down.")


app = FastAPI(title="Exfira PII Redaction Service (ChatGPT)", lifespan=lifespan)
...
@app.get("/health")
def health():
    return {"status": "ok", "redaction_engine": "chatgpt"}
...
async def redact_and_chat(req: ChatRequest, request: Request):
    ...
    # ── Step 1 & 2: Detect + anonymise via ChatGPT ────────────────────────────
    ...
    if vault:
        ...
        logger.info("   Detection  : %.1fms  —  %d entit%s found (via ChatGPT)",
