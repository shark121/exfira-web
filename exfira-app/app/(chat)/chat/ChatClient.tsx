...
export default function ChatClient({
  ...
  // Sync sidebar list whenever the server component re-renders with fresh data
  useEffect(() => {
  ...
  async function sendMessage(text?: string) {
    ...
    try {
      ...
      // Refresh server component so initialConversations prop updates, synced via useEffect
      router.refresh();
    } catch {
      setMessages((prev) => [
        ...prev,
